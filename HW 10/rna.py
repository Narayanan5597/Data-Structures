            ...
            if j == 0:
                ...
                while len(r) < k and len(h) != 0:
                    ...
                    if m_id == 0:
                        x = i[3]
                        a = _kbest(m[0], k)
                        if x + 1 < len(a) and (m[0], x + 1) not in used:
                            heapq.heappush(
                                h, (-a[x + 1][0], "." + a[x + 1][1], 0, x + 1)
                            )
                            used.add((m[0], x + 1))
                    else:
                        lx, rx = i[3], i[4]
                        ...
                        if (
                            lx + 1 < len(la)
                            and (m[m_id][0], m[m_id][1], lx + 1, rx) not in used
                        ):
                            heapq.heappush(
                                h,
                                (
                            ...
                            used.add((m[m_id][0], m[m_id][1], lx + 1, rx))
                        if (
                            rx + 1 < len(ra)
                            and (m[m_id][0], m[m_id][1], lx, rx + 1) not in used
                        ):
                            heapq.heappush(
                                h,
                                (
                            ...
                            used.add((m[m_id][0], m[m_id][1], lx, rx + 1))
                d[s] = r
        return d[s]
